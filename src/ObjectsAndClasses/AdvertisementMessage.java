...
public class AdvertisementMessage {
    static class Message {
        String[] phrases = {"Excellent fproduct.", "Such a great product.", "I always use that product.", "Best product of its category.", "Exceptional product.", "I can’t live without this product."};
